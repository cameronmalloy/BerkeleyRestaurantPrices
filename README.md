...
I used the data.py file in the Projects folder ([data.py](Project/data.py)) to gather all the data from the Yelp API. I deleted my secret in the file since this file is for proof of work.
